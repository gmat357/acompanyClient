var dataGetUrl = "/inquiry/commentGetList"; // 데이터를 가져올 링크
    ...
    for(var i = 0; i < maxListLength && i < data.length; i++){
        ...
        <tr>
            ...
            <td>
                ...
                <a href="/inquiry/commentDelete/${data[i].No}" class="comment_delete_btn"><img src="../public/img/inquiry/comment_delete.png" alt="댓글 삭제"></a>
            </td>
        </tr>
        `
    }
    ...
    for(var i = (page - 1) * maxListLength; i < maxListLength * page; i++){
        if(data[i] == undefined){
            ...
            <tr>
                ...
                <td>
                    <span value="${data[i].No}"><img src="../public/img/inquiry/comment_update.png" alt="댓글 수정"></span>
                    <a href="/"><img src="../public/img/inquiry/comment_delete.png" alt="댓글 삭제"></a>
                </td>
            </tr>
            `
        }
