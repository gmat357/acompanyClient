var dataGetUrl = "/review/commentGetList"; // 데이터를 가져올 링크
    ...
    for(var i = 0; i < maxListLength && i < data.length; i++){
        ...
        <tr>
            ...
            <td>
                ...
                <a href="/review/commentDelete/${data[i].No}" class="comment_delete_btn"><img src="../public/img/inquiry/comment_delete.png" alt="댓글 삭제"></a>
            </td>
        </tr>
        `
    }
