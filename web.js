...
app.post('/inquiry/update_page/:page',inquiryRouter);
app.post('/inquiry/updateAction/:page',inquiryRouter);
app.get('/inquiry/delete/:page',inquiryRouter);
app.post('/inquiry/deleteAction/:page',inquiryRouter);
...
app.post('/review/update_page/:page',reviewRouter);
app.post('/review/updateAction/:page',reviewRouter);
app.get('/review/delete/:page',reviewRouter);
app.post('/review/deleteAction/:page',reviewRouter);
...
app.post('/event/update_page/:page',eventRouter);
app.post('/event/updateAction/:page',eventRouter);
app.get('/event/delete/:page',eventRouter);
app.post('/event/deleteAction/:page',eventRouter);
